...
const {userProfileRouter,userLoginRouter,videoPostingRouter,subtopicRouter,eventRouter,searchRouter,eventPostingRouter,adminLoginRouter,videoGetRouter,courseDetailRouter,courseQuizRouter} = require('./controller') ;
